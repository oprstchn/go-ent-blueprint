...
func UserID(v xid.ID) predicate.Post {
	return predicate.Post(func(s *sql.Selector) {
...
func UserIDEQ(v xid.ID) predicate.Post {
	return predicate.Post(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldUserID), v))
	})
}
...
func UserIDNEQ(v xid.ID) predicate.Post {
	return predicate.Post(func(s *sql.Selector) {
...
func UserIDIn(vs ...xid.ID) predicate.Post {
	v := make([]any, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func UserIDNotIn(vs ...xid.ID) predicate.Post {
	v := make([]any, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func UserIDGT(v xid.ID) predicate.Post {
	return predicate.Post(func(s *sql.Selector) {
...
func UserIDGTE(v xid.ID) predicate.Post {
	return predicate.Post(func(s *sql.Selector) {
...
func UserIDLT(v xid.ID) predicate.Post {
	return predicate.Post(func(s *sql.Selector) {
...
func UserIDLTE(v xid.ID) predicate.Post {
	return predicate.Post(func(s *sql.Selector) {
...
func UserIDContains(v xid.ID) predicate.Post {
	vc := v.String()
	return predicate.Post(func(s *sql.Selector) {
...
func UserIDHasPrefix(v xid.ID) predicate.Post {
	vc := v.String()
	return predicate.Post(func(s *sql.Selector) {
...
func UserIDHasSuffix(v xid.ID) predicate.Post {
	vc := v.String()
	return predicate.Post(func(s *sql.Selector) {
...
func UserIDEqualFold(v xid.ID) predicate.Post {
	vc := v.String()
	return predicate.Post(func(s *sql.Selector) {
...
func UserIDContainsFold(v xid.ID) predicate.Post {
	vc := v.String()
	return predicate.Post(func(s *sql.Selector) {
