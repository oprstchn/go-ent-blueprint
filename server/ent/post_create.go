...
func (pc *PostCreate) SetUserID(x xid.ID) *PostCreate {
	pc.mutation.SetUserID(x)
	return pc
}

// SetNillableUserID sets the "user_id" field if the given value is not nil.
func (pc *PostCreate) SetNillableUserID(x *xid.ID) *PostCreate {
	if x != nil {
		pc.SetUserID(*x)
	}
	return pc
...
// SetUserID sets the "user_id" field.
func (u *PostUpsert) SetUserID(v xid.ID) *PostUpsert {
...
// SetUserID sets the "user_id" field.
func (u *PostUpsertOne) SetUserID(v xid.ID) *PostUpsertOne {
	return u.Update(func(s *PostUpsert) {
		s.SetUserID(v)
	})
}
...
// SetUserID sets the "user_id" field.
func (u *PostUpsertBulk) SetUserID(v xid.ID) *PostUpsertBulk {
	return u.Update(func(s *PostUpsert) {
		s.SetUserID(v)
	})
}
